//! Core types for Codex Account Switcher
...
/// Current workspace auth.json status.
...
/// Current live auth.json state as observed from the workspace.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct WorkspaceAuthState {
    pub path: String,
    pub exists: bool,
    pub status: WorkspaceAuthStatus,
    pub auth_mode: Option<AuthMode>,
    pub matched_account_id: Option<String>,
    pub matched_account_name: Option<String>,
    pub active_account_id: Option<String>,
    pub active_account_name: Option<String>,
    pub active_matches_live: bool,
    pub email: Option<String>,
    pub plan_type: Option<String>,
    pub error: Option<String>,
}

/// Account switch execution summary.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SwitchAccountResult {
    ...
    pub workspace_before: WorkspaceAuthState,
    pub workspace_after: WorkspaceAuthState,
    pub error: Option<String>,
}
